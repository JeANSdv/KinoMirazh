...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 17 2024 г., 02:42
...
(11, 'Тихое место', 'Семья с двумя детьми живёт на отдалённой ферме. Казалось бы, жизнь этих людей совершенно не отличается от жизни других таких семей, но они живут в месте, которое наполнено ужасными монстрами, реагирующими на любой звук.', 'Эмили Блант, Джон Красински, Ноа Джуп', '18+', 'США', 2018, 90, 'quietplace.jpg'),
...
(3, 'https://www.youtube.com/shorts/p0Z7h2j1xKc'),
(4, 'https://www.youtube.com/shorts/PWKqOxC9a1E'),
(5, 'https://www.youtube.com/shorts/Alm4WA3BDZc'),
(6, 'https://www.youtube.com/shorts/G4tezu1e85U'),
(7, 'https://www.youtube.com/watch?v=_kT_MbdRkRk'),
(8, 'https://www.youtube.com/shorts/i6v2EXdPx-I'),
(9, 'https://www.youtube.com/watch?v=9tRHtctkpM0'),
(10, 'https://www.youtube.com/shorts/VT_5koeX_W8'),
(11, 'https://www.youtube.com/shorts/Kq9VU-YtF98'),
(12, 'https://www.youtube.com/shorts/MmHCzeBeEIU');
...
--
ALTER TABLE `category`
  MODIFY `category_id` smallint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `film`
  MODIFY `film_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `price`
  MODIFY `price_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
