...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 23 2024 г., 16:00
...
(3, 'Джон Уик 2', 'Когда бывший коллега Джона решает взять под свой контроль таинственную гильдию убийц, Уик вынужден выйти из отставки. ', 'Киану Ривз, Риккардо Скамарчо, Иэн Макшейн, Руби Роуз\r\n', '18+', 'США, Гонконг', 2017, 122, '----'),
(4, 'Годзилла и Конг: Новая империя\r\n', 'Два древних титана, Годзилла и Конг, сражаются в эпической битве, пока люди разгадывают их происхождение и связь с тайнами Острова черепа.', 'Реббека Хол, Брайфн Тайри, Дэн Стивенс', '16+', 'США, Австралия', 2024, 115, '----'),
(5, 'Воздух', 'Великая Отечественная война. В СССР идут тяжелые бои, немецкая армия наступает. В смешанный авиационный полк прибывает подразделение летчиц', 'Анастасия Талызина, Аглая Тарасова, Кристина Лапшина, Сергей Безруков', '16+', 'Россия', 2023, 151, '---'),
(6, 'Топ Ган: Мэверик', 'Пит Митчелл по прозвищу Мэверик более 30 лет остается одним из лучших пилотов ВМФ: бесстрашный летчик-испытатель, он расширяет границы возможного и старательно избегает повышения в звании, которое заставило бы его приземлиться навсегда.', 'Том Круз, Майлз Теллер, Дженифер Конелли, Джон Хэмм', '16+', 'США', 2022, 130, '----'),
(7, 'Коллекционер ', 'Бывший домушник Аркин забирается в загородный коттедж своего начальника с тем, чтобы ограбив его, выплатить долг бывшей жене. ', 'Джош Стюарт, Хуан Фернандес, Карли Скот', '18+', 'США', 2009, 90, '---'),
(8, 'Судьба Человека', 'Фильм рассказывает о русском солдате, которого война подвергла страшным испытаниям, лишила дома и семьи, бросила в концлагерь. ', 'Сергей Бондарчуг, Павел Полунин, Зинаида Кириенко', '16+', 'СССР', 1959, 97, '---'),
(9, 'Однажды в Голливуде', '1969 год, золотой век Голливуда уже закончился. Известный актёр Рик Далтон и его дублер Клифф Бут пытаются найти свое место в стремительно меняющемся мире киноиндустрии.  \r\n', 'Лионардо Ди Каприо, Брэд Пит, Марго Робби', '16+', 'США, Великобритания, Китай', 2019, 161, '---'),
(10, 'Флешбек', 'Алекс Льюис, профессиональный киллер с репутацией, в какой-то момент пошел против ветра и теперь вынужден отбиваться и от ФБР, и от криминального босса. ', 'Лиам Нисон, Гай Пирс, Тадж Атвал', '16+', 'США', 2022, 114, '---'),
(11, 'Тихон место', 'Семья с двумя детьми живёт на отдалённой ферме. Казалось бы, жизнь этих людей совершенно не отличается от жизни других таких семей, но они живут в месте, которое наполнено ужасными монстрами, реагирующими на любой звук.', 'Эмили Блант, Джон Красински, Ноа Джуп', '18+', 'США', 2018, 90, '---'),
(12, 'Патруль', 'Лос-Анджелес. На первый взгляд это самый обычный город, живущий своей жизнью.', 'Майкл Пенья, Анна Кендрик, Натали Мартинес', '18+', 'США', 2012, 109, '---'),
...
(14, 'Лёд', 'С самого детства Надя верила в чудеса. Она представляла себе, как выходит на лёд под овации публики и танцует свой самый красивый танец. ', 'Аглая Тарасова, Диана Енакаева, Мария Аронова', '12+', 'Россия', 2018, 113, '---'),
(15, 'Джентльмены', 'Один ушлый американец ещё со студенческих лет приторговывал наркотиками, а теперь придумал схему нелегального обогащения с использованием поместий обедневшей английской аристократии и очень неплохо на этом разбогател.', 'Чарли Ханнэм, Генри Голдинк, Мишель Докери', '18+', 'США, Великобритания, Франция, Япония, Чехия', 2019, 113, '---'),
(16, 'ОНО', 'Когда в городке Дерри штата Мэн начинают пропадать дети, несколько ребят сталкиваются со своими величайшими страхами — не только с группой школьных хулиганов, но со злобным клоуном Пеннивайзом, список жертв которого уходит вглубь веков.', 'София Лиллис, Джек Дилан, Джейк Сим', '18+', 'США, Канада', 2017, 135, '---');
...
(3, 'https://www.youtube.com/watch?v=0DkJa_aGTP8'),
(4, 'https://www.youtube.com/watch?v=ac65s4A-VH0'),
(5, 'https://www.youtube.com/watch?v=kdRDumZq2xA'),
(6, 'https://www.youtube.com/watch?v=WKlWUNRjB_8\r\n'),
(7, 'https://www.youtube.com/watch?v=lq9DV7FsPg8'),
(8, 'https://www.youtube.com/watch?v=ov7bKyahGL4'),
(9, 'https://www.youtube.com/watch?v=zw81ihoukKU'),
(10, 'https://www.youtube.com/watch?v=q-bNkLPjnFU'),
(11, 'https://www.youtube.com/watch?v=gYwowpbn_xs'),
(12, 'https://www.youtube.com/watch?v=lR7OgDHwP-g'),
(13, 'https://www.youtube.com/watch?v=cbBK31-Zjhk'),
(14, 'https://www.youtube.com/watch?v=63vkDyLi98A'),
(15, 'https://www.youtube.com/watch?v=HGZ-IXSKjQ8'),
(16, 'https://www.youtube.com/watch?v=IisU-JHj_fU');
...
--
ALTER TABLE `payment_method`
  MODIFY `pmethod_id` smallint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT для таблицы `price`
--
ALTER TABLE `price`
  MODIFY `price_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `session`
  MODIFY `session_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
